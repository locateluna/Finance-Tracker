...
namespace Finance_Tracker.Controllers
{
    public class CreditCardsController : Controller
    {
        ...
        public CreditCardsController(Finance_TrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatementBalance,DueDate,MinPayment,InterestRate,Id,Name,Value")] CreditCard creditCard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatementBalance,DueDate,MinPayment,InterestRate,Id,Name,Value")] CreditCard creditCard)
        {
            if (id != creditCard.Id)
            {
                return NotFound();
