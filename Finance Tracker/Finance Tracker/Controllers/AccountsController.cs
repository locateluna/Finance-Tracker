...
namespace Finance_Tracker.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(Finance_TrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Value")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Value")] Account account)
        {
            if (id != account.Id)
            {
                return NotFound();
